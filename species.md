...
- **Juglone:** Tolerates black walnut allelopathy
- **Wildlife:** Pollinator/butterfly value (H = high, M = medium, L = low)
...
- **Spread:** 18–24" clump
- **Juglone:** Tolerant ✓
- **Wildlife:** Hummingbirds, bees (H)
- **Transplant:** Fibrous roots = jug-then-plant works
- **Notes:** Scarlet Bee Balm (*M. didyma*) preferred over wild bergamot for flower color. Planted west slope south end. June 2026: branched, healthy, establishing well.
...
- **Height:** 1.5–2.5 ft
- **Light:** Full sun
- **Soil:** Sandy-loam, very well-drained; avoids clay and wet
- **Spread:** 12–18" clump
- **Juglone:** Poor tolerance
- **Wildlife:** Monarch caterpillar host (H); butterflies (H)
- **Transplant:** Deep taproot = direct-sow only; avoid jugs entirely
- **Notes:** 2026 jug attempt (west slope north end) failed — deep-taproot species don't transplant (root shock), not a site verdict. Direct-sow is the corrected method. **Largest west slope footprint: 33 positions, Band 1 north** — all above the stairs, entirely clear of the SW walnut (BW is juglone-shy). The 45° slope drains sharply, which the taproot wants.
...
- **Spread:** 12–24" clump
- **Juglone:** Tolerant ✓
- **Wildlife:** Bees, butterflies (H); goldfinches eat seed
...
- **Spread:** 24–36" clump
- **Juglone:** Tolerant (mother plant thriving downhill on the property)
- **Wildlife:** Bees, butterflies (M)
- **Transplant:** Taproot species = direct-sow only
- **Notes:** **Mother plant (genetic insurance) STILL STANDING downhill on the property.** Year-old seedlings in two patches uphill on the property; survivors confirmed after transplant shock. Seeds collected annually from mother plant. Natural area plantings, not border.
...
- **Spread:** 24–36" clump
- **Juglone:** Tolerant ✓
- **Wildlife:** Minimal (not native; minimal pollinator value)
- **Notes:** Divisions from a friend planted north edge, year ago. All 17 survived winter; flowering confirmed June 2026. Bridge plantings—establishes faster than natives, fills space while natives get established. Non-native but well-behaved, not invasive.
- **Status:** Established; June flowering observed

### Two Leggy Scarlet Bee Balm (Diagnostic Case)
...
- **Spread:** 12–18" clump
- **Juglone:** Tolerant ✓
- **Wildlife:** Black swallowtail caterpillar host (H); bees (H)
- **Sourcing:** Prairie Moon Nursery (northeast ecotype)
- **Critical note:** **BUY SEED ONLY.** Never wild-collect Apiaceae—wild parsnip, poison hemlock, water hemlock, giant hogweed all look similar.
...
- **Spread:** Spreads via rhizomes; 24–36" after 2–3 years
- **Juglone:** Tolerant ✓
- **Wildlife:** Bees, butterflies (H); forage-rich all summer
- **Sourcing:** Prairie Moon Nursery
- **Notes:** Summer-long pollinator workhorse. Self-sows readily (volunteer seedlings expected years 2+). Spreads—place with intent.
- **Status:** Fall 2026 order pending
...
- **Height:** 1–2 ft
- **Light:** Full sun
- **Soil:** Well-drained; drought-tolerant; poor soil OK
- **Spread:** 18–24" clump
- **Juglone:** Tolerant ✓
- **Wildlife:** Bees, butterflies (M)
- **Sourcing:** **Organo Republic via Amazon** (Prairie Moon doesn't carry it)
- **Critical note:** Straight species, white wild form only—no pink/yellow cultivars
...
- **Height:** 1–2 ft
- **Light:** Part shade to full sun (prefers part shade)
- **Soil:** Well-drained, rocky/sandy preferred
- **Spread:** 12–18" clump
- **Juglone:** Tolerant ✓
- **Wildlife:** Hummingbirds (H); bees (M)
- **Sourcing:** Prairie Moon Nursery
- **Notes:** Early spring interest. Suitable for north edge (afternoon shade). NOT suitable for the full-sun south frontage.
- **Status:** Fall 2026 order pending
...
- **Juglone:** Tolerant ✓
- **Wildlife:** Bees, butterflies (H)
- **Transplant:** Taproot species = direct-sow preferred (jug rate was poor 2026)
...
- **Light:** Part shade (prefers dappled)
- **Soil:** Acidic, well-drained; ericaceous
- **Juglone:** Tolerant ✓
- **Wildlife:** Bees (M)
- **Sourcing:** Seed project underway (Sheffield's Seed Company or F.W. Schumacher Co.). Sow fall 2026, grow 3–5 years in pots, landscape 2030–2031.
- **Critical:** Requires mycorrhizal inoculation (ericoid fungi partnership). Use soil from established rhododendron/blueberry patch if available; commercial ericaceous inoculant as backup.
- **Status:** Seed + medium ordered for 2027 start
...
- Establishes well, validates direct-sow + full clearing approach
- Coneflower provides structure; bee balm fills in horizontally
- Both drought-tough for full sun

**West Slope Combo (South):** Scarlet Bee Balm + Wild Bergamot (juglone-tolerant)
- Both are fibrous-rooted = container-to-ground transplant OK
- June establishment excellent; ready for year-two vigor
- Juglone-safe; walnut tree cannot suppress
...
| Organo Republic (Amazon) | White yarrow (only source confirmed) |
