...
- **Direct-sow priority seeds** (post-frost = reduced mouse predation):
  - New England Aster
  - Smooth Blue Aster
  - Butterfly Weed (Asclepias tuberosa) — locally collected, not ordered
  - Common Milkweed (Asclepias syriaca) — locally collected, not ordered
  - Golden Alexanders (Zizia aurea) — packet
...
| Group | Species | Seeds/sq ft | Seeds per 3×3 patch | Notes |
|-------|---------|-------------|---------------------|-------|
| Tiny-seeded | Asters, yarrow, mint, bee balm | 10–15 | small pinch broadcast | Can't oversow to waste; self-thins |
| Medium-seeded | Columbine, golden alexander | 5–8 | 45–70 seeds | Columbine especially — don't crowd |
...
- Inventory remaining seed for spring follow-up
- Prepare ericaceous medium for mountain laurel seed project (start 2027)
...
### Dormancy Phase
- Natural stratification of direct-sown seeds
- Monitor for runoff/erosion on slopes
- Repair frost heave if needed on mulched patches
- Plan 2027 spring survey (single-line on east border)
...
### April–May
- Monitor germination of fall-sown seeds
- Weed suppression around seedlings (hand-pull to avoid disturbance)
- Day lily flowering on north edge (expected; 2nd year bloom)
- Bee balm on the south frontage and west slope likely to bloom early season
- Do NOT deadhead or cut back as seeds/pollinators establish

### Late May–Early June
- Assess which fall-sown species germinated
- Plan gap-filling for failed patches
- Mountain Laurel seed: sow in pots for 2027 germination (if ericaceous medium ready)
...
### June–July
- First blooms expected: bee balm (the south frontage, west slope), day lilies, surviving 2026 plants
- Monitor moisture on newly germinated patches
- Light hand-tending only; avoid mowing seeded areas
- Butterflies establish on milkweed/asters (monarch nectaring)

### August
- Coneflower approaching bloom on the south frontage
- Bee balm peak bloom
- Begin seed collection prep: gather containers, labels
- Scout for new planting opportunities

---

## Fall 2027 (September–November)

### Repeat fall 2026 protocol:
...
- Bee balm seed collection (save for genetic selection)
- Aster flowering begins; survey for genetic traits to propagate
...
- Privacy screen project: fall 2026 (west slope), fall 2027 (East), fall 2028 (north edge), fall 2029 (the south frontage)
